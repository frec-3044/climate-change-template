This repository is a template for the climate change module. This is the fourth module of FREC 3044 Environmental Data Science, intended to use tidyverse skills to perform basic modeling in R.
