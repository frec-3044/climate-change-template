...
You will need to figure out the file's delimiter and any comments or skips. You will also need to be sure that you have column names. You will not directly use the code above to read the CO2 data, but that code provides helpful tips for reading the data.
...
You will use rolling averages to help you explore the evidence for a pause. Since you have not been provided instructions for calculating rolling means, this question's learning objective is to practice finding the solution.

**Question 6:**

Use a search engine (e.g., Google) to find out how to calculate a rolling average in R. What search term did you use, and what website did you end up using?  Why did you select this particular website?
